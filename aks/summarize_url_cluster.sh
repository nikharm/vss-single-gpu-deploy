...
#
# Examples:
#   ./summarize_url_cluster.sh "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4"
#   ./summarize_url_cluster.sh "https://repo.jellyfin.org/archive/jellyfish/media/jellyfish-140-mbps-4k-uhd-h264.mkv"
#
# Prerequisites:
...
# --- Step 1: Download + Upload on-cluster via kubectl exec ---
echo ""
...
# --- Step 2: Summarize (via local port-forward — small JSON payload) ---
echo ""
